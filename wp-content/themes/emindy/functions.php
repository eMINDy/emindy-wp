 ...
 * frontend/admin helpers.  This version has been refactored to avoid
 * any PHP 7+ type declarations so it will run on older PHP versions
 * (e.g. PHP 5.6).  Return types (e.g. `: void`) and typed parameters
 * (e.g. `string $var`) have been removed.  The functionality remains
 * unchanged.
 */
