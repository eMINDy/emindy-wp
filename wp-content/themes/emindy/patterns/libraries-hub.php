...
<main id="main-content" class="wp-block-group">
  ...
  <div class="wp-block-group is-style-em-card" style="padding:.75rem;margin-bottom:1rem">
    <!-- wp:html -->
    <form role="search" method="get" action="/" class="em-library-search" style="display:flex;gap:.5rem;flex-wrap:wrap;align-items:center;margin:.25rem 0 .75rem">
      <label for="emlibrary-hub-s" class="sr-only">Search the library</label>
    ...
    <div class="wp-block-columns">
      ...
      <div class="wp-block-column">
        ...
        <div class="wp-block-group is-style-em-card" style="padding:1rem">
          ...
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
          <p><a href="/videos/"><?php echo esc_html__( 'Visit hub →', 'emindy' ); ?></a> | <a href="/video-library/"><?php echo esc_html__( 'Full archive →', 'emindy' ); ?></a></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column">
        <div class="wp-block-group is-style-em-card" style="padding:1rem">
          ...
          <p><a href="/exercises/"><?php echo esc_html__( 'Visit hub →', 'emindy' ); ?></a> | <a href="/exercise-library/"><?php echo esc_html__( 'Full archive →', 'emindy' ); ?></a></p>
        </div>
      </div>
      <!-- /wp:column -->
      <!-- Articles card -->
      <div class="wp-block-column">
        <div class="wp-block-group is-style-em-card" style="padding:1rem">
          ...
          <p><a href="/articles/"><?php echo esc_html__( 'Visit hub →', 'emindy' ); ?></a> | <a href="/article-library/"><?php echo esc_html__( 'Full archive →', 'emindy' ); ?></a></p>
        </div>
      </div>
      <!-- /wp:column -->
      <!-- Blog posts card -->
      <div class="wp-block-column">
        <div class="wp-block-group is-style-em-card" style="padding:1rem">
          ...
          <p><a href="/blog/"><?php echo esc_html__( 'Visit blog →', 'emindy' ); ?></a></p>
        </div>
      </div>
      <!-- /wp:column -->
    </div>
  ...
  <div class="wp-block-group is-style-em-card" style="margin-top:1rem;padding:1rem">
    ...
    <div class="wp-block-buttons">
      ...
      <div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="/archive-library/"><?php echo esc_html__( 'Go to archive', 'emindy' ); ?></a></div>
      <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
  </div>
